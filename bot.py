...
class DiscordGSM():
    ...
    def get_embed(self, server):
        ...
        embed.set_footer(
            text=f'DiscordGSM v{VERSION} | 📺Game Server Monitor | Last update: ' + datetime.now().strftime(
                '%a, %Y-%m-%d %I:%M:%S%p'),
            icon_url='https://github.com/DiscordGSM/DiscordGSM/raw/master/images/discordgsm.png')
